...
const TeachAccount = () => {
  ...
  const baseURL = 'https://studentassistant-18fdd-default-rtdb.firebaseio.com/accounts/Teachers';
...
const editAccount = (index, accountId) => {
  ...
  return (
    <>
      <h3>Accounts/<span>Teacher</span></h3>
      <div className="stud-account-container">
        <div className="stud-account-card">
          <h4 className='stud-account-title'>Add Teacher Account</h4>
