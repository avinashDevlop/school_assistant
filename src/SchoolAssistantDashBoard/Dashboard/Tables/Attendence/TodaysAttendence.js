...
useEffect(() => {
  ...
  // Fetches attendance names for the selected class and section
  useEffect(() => {
    const fetchAttendanceNames = async () => {
      try {
        ...
        setAttendanceNames(attendanceResponse.data || {});
      } catch (error) {
        console.error("Error fetching attendance names:", error);
      }
    };
  ...
  // Toggles the attendance for a student
                ...
                <thead>
                  <tr>
                    ...
                    <th className="center">
                      ...
                      / Present:{" "}
                      <span className="Present">{presentStudents}</span>
                    </th>
                  </tr>
                </thead>
                <tbody>
