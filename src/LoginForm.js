...
const LoginForm = () => {
  ...
  try {
    ...
    if (user) {
      ...
      navigate("/SchoolAssistantDashBoard/welcomeInfo/ProfileDeatails");
    } else {
  ...
  return (
    ...
    <div className="d-flex justify-content-center align-items-center" style={{paddingTop:'40px'}}>
      <div id='abc' className="col-md-4 p-3 shadow-sm border rounded-5 border-primary login" style={{width:'370px',height:'450px'}}>
