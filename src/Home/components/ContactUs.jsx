              ...
              <div className="row">
                <div className="col-md-9 col-lg-7">
                  <div className="contact-wrap w-100 p-md-5 p-4">
                    ...
                    {formStatus.warning && (
                      <div id="form-message-warning" className="mb-4">{formStatus.warning}</div>
                    )}
                    {formStatus.success && (
                      <div id="form-message-success" className="mb-4">{formStatus.success}</div>
                    )}
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-12">
                          <div className="form-group">
                            ...
                            <textarea name="message" className="form-control" id="message" cols="30" rows="4" placeholder="Message" value={formData.message} onChange={handleChange}></textarea>
                          </div>
                        </div>
                        <div className="col-md-12">
                          <div className="form-group">
